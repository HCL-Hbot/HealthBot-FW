...
namespace LED
{
    ...
    public:
        LedStripController(uint pin1, uint numLeds1, uint pin2, uint numLeds2)
            : strip1(PicoLed::addLeds<PicoLed::WS2812B>(pio0, 0, pin1, numLeds1, PicoLed::FORMAT_RGB)),
              strip2(PicoLed::addLeds<PicoLed::WS2812B>(pio1, 0, pin2, numLeds2, PicoLed::FORMAT_RGB))
        {
            clear();
        }
